export default {
    ...
    INVALID_CONVERSATION_KEY: 'INVALID_CONVERSATION_KEY',
    MODEL_IS_UNDEFINED: 'MODEL_IS_UNDEFINED',
    MODEL_IS_UNSUPPORTED: 'MODEL_IS_UNSUPPORTED',
    KEY_NAME_IS_UNDEFINED: 'KEY_NAME_IS_UNDEFINED',
